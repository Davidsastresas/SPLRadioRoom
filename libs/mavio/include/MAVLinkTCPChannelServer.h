...
#ifndef LIBS_MAVIO_INCLUDE_MAVLINKTCPCHANNELServer_H_
#define LIBS_MAVIO_INCLUDE_MAVLINKTCPCHANNELServer_H_
 ...
 */
class MAVLinkTCPChannelServer : public MAVLinkChannel {
 public:
  /**
   * Constructs an instance of MAVLinkTcpClient.
   */
  MAVLinkTCPChannelServer();

  /**
   * Closes connection and frees the resources.
   */
  virtual ~MAVLinkTCPChannelServer();
...
#endif  // LIBS_MAVIO_INCLUDE_MAVLINKTCPCHANNELServer_H_
