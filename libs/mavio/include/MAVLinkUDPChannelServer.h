 ...
 */
class MAVLinkUDPChannelServer : public MAVLinkChannel {
 public:
  /**
   * Constructs an instance of MAVLink UDPClient.
   */
  MAVLinkUDPChannelServer();

  /**
   * Closes connection and frees the resources.
   */
  virtual ~MAVLinkUDPChannelServer();
