...
#ifndef LIBS_MAVIO_INCLUDE_MAVLINKAUTOPILOTAIR_H_
#define LIBS_MAVIO_INCLUDE_MAVLINKAUTOPILOTAIR_H_
 ...
 * interface.
 */
class MAVLinkAutopilotAir : public MAVLinkChannel {
 public:
  /**
...
#endif  // LIBS_MAVIO_INCLUDE_MAVLINKAUTOPILOTAir_H_
